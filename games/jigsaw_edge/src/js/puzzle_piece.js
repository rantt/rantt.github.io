var PuzzlePiece = function(game, x, y, j, i, width, height, pic, sides) {
  ...
  var sourceWidth = Math.min(w, img.naturalWidth);
  var sourceHeight = Math.min(h, img.naturalHeight);

  // Phaser.Sprite.call(this, this.game, x-offsetX, y-offsetY, bmd);
  Phaser.Sprite.call(this, this.game, sourceWidth, sourceHeight, bmd);
